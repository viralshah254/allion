      ...
      <div className="container mx-auto px-6 md:px-12 py-16 md:py-24">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 text-oda-blue mb-12 md:mb-0 md:pr-12">
            <h1 className="font-helvetica font-bold text-4xl md:text-5xl mb-6">
              Unlock Your Financial Investment Opportunity
            </h1>
            <p className="font-helvetica font-normal text-xl mb-8 text-gray-700">
              Securing your future with confidence. At Allion, we provide personalized insurance solutions designed to protect what matters most.
            </p>
          ...
          <div className="md:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg transform transition-transform hover:scale-105 border-t-4 border-airforce-blue">
              ...
              <h3 className="font-helvetica font-bold text-oda-blue text-xl mb-2">Your Pathway to Financial Security</h3>
              <p className="font-helvetica text-gray-700">Starts Now</p>
              <div className="mt-4 flex justify-between items-center">
                <span className="font-helvetica font-bold text-3xl text-oda-indigo">$77K</span>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg transform transition-transform hover:scale-105 border-t-4 border-auburn">
              ...
              <h3 className="font-helvetica font-bold text-oda-blue text-xl mb-2">Building Security for Life's Uncertainty</h3>
              <p className="font-helvetica text-gray-700">Comprehensive Coverage</p>
              <div className="mt-4 flex justify-between items-center">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-gray-500">
            <div className="font-helvetica font-bold">WALMART</div>
            <div className="font-helvetica font-bold">FACEBOOK</div>
            <div className="font-helvetica font-bold">AMAZON</div>
            <div className="font-helvetica font-bold">UNICEF</div>
            <div className="font-helvetica font-bold">GOOGLE</div>
          </div>
        </div>
      </div>
    </div>
