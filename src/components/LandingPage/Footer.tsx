        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-airforce-blue transition-colors">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/life" className="font-helvetica font-light hover:text-airforce-blue transition-colors">Life Insurance</Link>
              </li>
              <li>
                <Link to="/health" className="font-helvetica font-light hover:text-airforce-blue transition-colors">Health Insurance</Link>
              </li>
              <li>
                <Link to="/auto" className="font-helvetica font-light hover:text-airforce-blue transition-colors">Auto Insurance</Link>
              </li>
              <li>
                <Link to="/home" className="font-helvetica font-light hover:text-airforce-blue transition-colors">Home Insurance</Link>
              </li>
              <li>
                <Link to="/business" className="font-helvetica font-light hover:text-airforce-blue transition-colors">Business Insurance</Link>
              </li>
            </ul>
          </div>
